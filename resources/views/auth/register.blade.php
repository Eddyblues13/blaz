...
<head>
    ...
    <title>Register - Blazespom</title>
    ...
    <div class="register-container">
        ...
        <form id="registerForm" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" required id="id_email" value="{{ old('email') }}">
        ...
        <p class="mt-3 text-center">Already registered? <a href="{{ route('login') }}">Login</a></p>
    </div>
